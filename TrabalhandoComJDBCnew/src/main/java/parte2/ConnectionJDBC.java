...
public class ConnectionJDBC {
    ...
    public static void main(String[] args) {
        ...
        String connectionUrl = sb.toString(); //sb.toString() == "jdbc:mysql://localhost/Banco_JDBC";

        //CARREGAR A CLASSE ESPECÍFICA DE IMPLEMENTAÇÃO DO DRIVER NA MEMÓRIA DA JVM.(A PARTIR DA VERSÃO 4 NÃO É MAIS NECESSÁRIO!!!)
